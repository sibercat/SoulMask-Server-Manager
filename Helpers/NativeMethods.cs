...
internal static class NativeMethods
{
    ...
    /// <summary>
    /// Opt a control out of Windows visual theming (uxtheme.dll).
    /// Pass " " for both args to disable theming entirely — lets explicit
    /// BackColor/ForeColor/SelectionColor take effect without OS override.
    /// </summary>
